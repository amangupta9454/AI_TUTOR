...
//               <div className="absolute inset-0 bg-gradient-to-r from-white to-gray-300 rounded-full blur-xl opacity-20 animate-pulse"></div>
//               <div className="relative bg-gradient-to-r from-gray-800 to-black p-6 rounded-full shadow-2xl border border-gray-600">
//                 <Briefcase className="w-12 h-12 text-white animate-bounce" />
//               </div>
//             </div>
//           </div>
//           <h1 className="text-6xl md:text-7xl font-black bg-gradient-to-r from-white via-gray-300 to-gray-500 bg-clip-text text-transparent mb-6 animate-gradient">
//             Career Opportunities Analyzer
//           </h1>
//           <p className="text-xl text-gray-300 max-w-4xl mx-auto leading-relaxed">
//             Discover trending job opportunities and market insights with AI-powered analysis. 
//             Get real-time data updated weekly to accelerate your career growth.
//           </p>
...
//         {/* Error Display */}
//         {error && (
//           <div className="mb-8 p-6 bg-red-900/50 border border-red-500/50 rounded-2xl text-red-300 text-center shadow-2xl backdrop-blur-lg animate-shake">
...
//             {/* Stats Header */}
//             <div className="relative">
//               <div className="absolute inset-0 bg-gradient-to-r from-white/10 to-gray-300/10 rounded-3xl blur-xl"></div>
...
//                     <div className="relative">
//                       <div className="absolute inset-0 bg-gradient-to-r from-white to-gray-400 rounded-2xl blur-lg opacity-30"></div>
//                       <div className="relative bg-gradient-to-r from-gray-800 to-black p-4 rounded-2xl shadow-xl border border-gray-600">
//                         <BarChart3 className="w-8 h-8 text-white" />
//                       </div>
//                     </div>
//                     <div>
//                       <h2 className="text-3xl font-bold text-white mb-2">Market Analysis Ready</h2>
...
//                       className="relative group bg-gradient-to-r from-gray-800 to-black hover:from-gray-700 hover:to-gray-900 disabled:opacity-50 px-6 py-3 rounded-2xl text-white font-semibold transition-all duration-300 flex items-center space-x-2 shadow-xl hover:shadow-2xl transform hover:scale-105 active:scale-95 border border-gray-600"
//                     >
//                       <div className="absolute inset-0 bg-gradient-to-r from-white/10 to-gray-300/10 rounded-2xl blur opacity-0 group-hover:opacity-50 transition-opacity duration-300"></div>
//                       <RefreshCw className={`w-4 h-4 relative z-10 ${isRefreshing ? 'animate-spin' : ''}`} />
...
//                 <div className="relative bg-gray-900/80 backdrop-blur-xl border border-gray-700/50 rounded-3xl p-8 shadow-2xl hover:shadow-3xl transition-all duration-300">
//                   <div className="flex items-center mb-6">
//                     <div className="bg-gradient-to-r from-gray-800 to-black p-3 rounded-xl mr-4 shadow-lg border border-gray-600">
//                       <TrendingUp className="w-6 h-6 text-white" />
//                     </div>
//                     <h3 className="text-2xl font-bold text-white">Job Demand Trends</h3>
//                   </div>
...
//                     </div>
//                     <h3 className="text-2xl font-bold text-white">Salary Ranges</h3>
//                   </div>
...
//                 </div>
//                 <h3 className="text-3xl font-bold text-white">Top Career Opportunities</h3>
//               </div>
//               <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
//                 {opportunitiesData.opportunities.map((opportunity, index) => (
//                   <OpportunityCard key={index} opportunity={opportunity} rank={index + 1} />
//                 ))}
//               </div>
//             </div>
...
//             {/* Market Insights */}
//             <div className="relative">
//               <div className="absolute inset-0 bg-gradient-to-r from-white/20 to-gray-300/20 rounded-3xl blur-2xl"></div>
//               <div className="relative bg-gradient-to-r from-gray-900/90 to-black/90 backdrop-blur-xl border border-gray-700/50 rounded-3xl p-12 shadow-2xl">
//                 <div className="flex items-center mb-8">
//                   <div className="bg-white/10 p-4 rounded-xl mr-6 backdrop-blur-lg shadow-xl border border-gray-600">
//                     <Users className="w-10 h-10 text-white" />
//                   </div>
//                   <h3 className="text-4xl font-bold text-white">Market Insights</h3>
//                 </div>
//                 <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
//                   <div className="text-center group">
//                     <div className="relative mb-6">
//                       <div className="absolute inset-0 bg-white/10 rounded-3xl blur-xl group-hover:blur-2xl transition-all duration-300"></div>
//                       <div className="relative bg-white/5 w-24 h-24 rounded-3xl flex items-center justify-center mx-auto backdrop-blur-lg border border-gray-600 shadow-xl group-hover:scale-110 transition-transform duration-300">
//                         <TrendingUp className="w-12 h-12 text-white" />
//                       </div>
//                     </div>
//                     <h4 className="text-xl font-semibold text-white mb-3">Growth Rate</h4>
//                     <p className="text-5xl font-black text-white mb-2">+{opportunitiesData.insights?.growthRate || '25'}%</p>
...
//                       </div>
//                     </div>
//                     <h4 className="text-xl font-semibold text-white mb-3">Avg. Salary</h4>
//                     <p className="text-5xl font-black text-white mb-2">${opportunitiesData.insights?.avgSalary || '85,000'}</p>
//                     <p className="text-gray-400 text-sm">Annual median</p>
//                   </div>
...
//                       </div>
//                     </div>
//                     <h4 className="text-xl font-semibold text-white mb-3">Job Openings</h4>
//                     <p className="text-5xl font-black text-white mb-2">{opportunitiesData.insights?.jobOpenings || '12,500'}+</p>
//                     <p className="text-gray-400 text-sm">Available positions</p>
//                   </div>
//                 </div>
//               </div>
//             </div>
...
//               <div className="absolute inset-0 bg-gradient-to-r from-white/10 to-gray-300/10 rounded-3xl blur-2xl"></div>
//               <div className="relative bg-gray-900/80 backdrop-blur-xl border border-gray-700/50 rounded-3xl p-16 shadow-2xl">
//                 <div className="relative mb-8">
//                   <div className="w-20 h-20 border-4 border-gray-600/30 border-t-white rounded-full mx-auto animate-spin"></div>
//                   <div className="absolute inset-0 w-20 h-20 border-4 border-gray-500/30 border-b-gray-300 rounded-full mx-auto animate-spin" style={{animationDirection: 'reverse', animationDuration: '1.5s'}}></div>
//                 </div>
//                 <h3 className="text-3xl font-bold text-white mb-4">Analyzing Market Data</h3>
//                 <p className="text-gray-300 text-lg">AI is processing current market trends...</p>
