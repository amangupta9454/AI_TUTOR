    ...
    <div className="relative min-h-screen bg-gradient-to-br from-black via-gray-900 to-gray-800 text-white overflow-hidden">
      ...
      <div className="relative z-10 px-4 py-12 md:py-20 lg:px-20 space-y-16 md:space-y-24 lg:space-y-32">
        ...
        <section className="max-w-7xl mx-auto transform transition-all duration-1000 hover:scale-[1.01]">
          ...
          <div className="backdrop-blur-xl bg-white/10 rounded-2xl md:rounded-3xl border border-white/30 p-4 sm:p-6 md:p-10 lg:p-16 shadow-xl md:shadow-2xl hover:bg-white/15 transition-all duration-700 hover:border-white/40">
            <p className="text-gray-100 text-sm sm:text-base md:text-lg lg:text-xl xl:text-xl leading-relaxed mb-8 md:mb-12 lg:mb-16 font-normal">
              The AI Career Coach platform is designed to tackle major career challenges faced by job seekers and students in today's competitive landscape. Here's a breakdown of the specific problems it addresses:
            </p>
        ...
        <section className="max-w-7xl mx-auto transform transition-all duration-1000 hover:scale-[1.01]">
          ...
          <div className="backdrop-blur-xl bg-white/10 rounded-2xl md:rounded-3xl border border-white/30 p-4 sm:p-6 md:p-10 lg:p-16 shadow-xl md:shadow-2xl hover:bg-white/15 transition-all duration-700 hover:border-white/40">
            <p className="text-gray-100 text-sm sm:text-base md:text-lg lg:text-xl xl:text-xl leading-relaxed mb-8 md:mb-12 lg:mb-16 font-normal">
              The scope of AI Career Coach spans across multiple facets of the job-seeking and career development journey. It aims to support not just fresh graduates but also working professionals and career switchers.
            </p>
        ...
        <section className="max-w-6xl mx-auto transform transition-all duration-1000 hover:scale-[1.01]">
          <div className="text-center mb-11 md:mb-14 lg:mb-16">
            ...
            <p className="text-gray-200 text-sm sm:text-base md:text-lg lg:text-xl xl:text-xl mt-4 md:mt-6 lg:mt-10 max-w-5xl mx-auto leading-relaxed font-normal">
              Our AI Career Coach platform is packed with a wide array of powerful, user-centric features designed to support every phase of the job search and career growth process.
            </p>
          </div>
        ...
        <section className="max-w-7xl mx-auto transform transition-all duration-1000 hover:scale-[1.01]">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8 lg:gap-10">
            {[
              { name: "Aman Gupta", role: "Full Stack Web Developer", image: st2, quote: "As the lead developer, I aimed to craft a seamless, responsive experience with complete Backend code of the project." },
              { name: "Himanshu Gupta", role: "Full Stack Web Developer", image: st3, quote: "My focus was designing the AI interview and resume systems. " },
              { name: "Anshika Yadav", role: "Frontend Developer", image: st1, quote: "I designed the platform with accessibility and simplicity in mind. " },
              { name: "Manish Dargan", role: "Prompt & Full Stack Web Developer", image: st4, quote: "This project is more than code—it's impact. I ensured we reach the right audience.I crafted the Prompt with more features. " }
            ].map((member, index) => (
